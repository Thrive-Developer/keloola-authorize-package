...
return [
    ...
    'error_404'                     => 'Not found',
    'empty_data'                    => 'The data not found',
    'empty_file'                    => 'The file not found',
    'error_validation'              => 'Validation Error',
    'payload_error'                 => 'The payload is invalid',
    'unauthorized'                  => 'Unauthorized',
    'empty_subscribtion'            => 'You do not have access to the application. Please subscribe first.',
    'empty_application'             => 'You do not have access to the application. Please subscribe first.',
    'empty_applications'            => 'You do not have access to the any application.',
    'empty_organization'            => 'You do not have organization',
